...
local ok_p5, protocol5 = pcall(require, "mqtt.protocol5")  -- optional: protocol5.lua excluded to minimize size
local make_packet5 = ok_p5 and protocol5.make_packet or nil
local parse_packet5 = ok_p5 and protocol5.parse_packet or nil
