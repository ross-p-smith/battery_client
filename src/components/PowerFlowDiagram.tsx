    ...
    <div className="rounded-xl border border-zinc-800 bg-zinc-900 p-5">
      ...
      <div className="space-y-2">
        <FlowArrow
          from="Solar"
          to="House"
          watts={Flows.Solar_to_House}
          color="text-amber-400"
        />
        <FlowArrow
          from="Solar"
          to="Battery"
          watts={Flows.Solar_to_Battery}
          color="text-amber-500"
        />
        <FlowArrow
          from="Solar"
          to="Grid"
          watts={Flows.Solar_to_Grid}
          color="text-amber-600"
        />
        <FlowArrow
          from="Grid"
          to="House"
          watts={Flows.Grid_to_House}
          color="text-blue-400"
        />
        <FlowArrow
          from="Grid"
          to="Battery"
          watts={Flows.Grid_to_Battery}
          color="text-blue-500"
        />
        <FlowArrow
          from="Battery"
          to="House"
          watts={Flows.Battery_to_House}
          color="text-emerald-400"
        />
        <FlowArrow
          from="Battery"
          to="Grid"
          watts={Flows.Battery_to_Grid}
